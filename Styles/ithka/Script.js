...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const logoContainer = $('<div class="navbarBrand"><a target="_blank"><img src="https://frontenduiux.github.io/OBB_Services/Images/logoIthca.png" alt="Oman Broad Band"></a></div>');
...
//  { text: "Home", url: "/Runtime/Runtime/Form/ArchivingLandingForm/" },
	...
	}else if(currentUrl.includes("ITHCA.Incoming") || currentUrl.includes("ITHCA.Outgoing") || currentUrl.includes("ITHCA.Outing") || currentUrl.includes("ITHCA.ICMS.DataDashboard1") || currentUrl.includes("ITHCA.OCMS.DataDashboard1") || currentUrl.includes("ITHCA.OCMS.RequestReadOnly.Form1") || currentUrl.includes("ITHCA.ICMS.RequestReadOnly.Form") || currentUrl.includes("ITHCA.NewIncomingRequestCreation.SubmitForm") || currentUrl.includes("ITHCA.NewOutingRequestCreation.SubmitForm")) {
				menuItems = [
        // { text: "Home", url: "/Runtime/Runtime/Form/IncomingRequest.AllRequestsForm/" },
		{
					text: "New Request", url: "", children: [
						{ text: "Incoming Request", url: "/Runtime/Runtime/Form/ITHCA.NewIncomingRequestCreation.SubmitForm/" },
						{ text: "Outgoing Request", url: "/Runtime/Runtime/Form/ITHCA.NewOutingRequestCreation.SubmitForm/" }
					]
		},
        {
					text: "Incoming Correspondence", url: "", children: [
						{ text: "InProgress", url: "/Runtime/Runtime/Form/ITHCA.IncomingRequest.InProgressRequestForm/" },
						{ text: "Closed", url: "/Runtime/Runtime/Form/ITHCA.IncomingRequest.ClosedRequestForm/" },
						{ text: "All Requests", url: "/Runtime/Runtime/Form/ITHCA.IncomingRequest.AllRequestsForm/" },
						{ text: "My Tasks", url: "/Runtime/Runtime/Form/ITHCA.IncomingRequest.Worklist/" },
                        { text: "Old Data", url: "/Runtime/Runtime/Form/ICMS.DataDashboard1/" }

					]
		},
		{
					text: "Outgoing Correspondence", url: "", children: [
						{ text: "InProgress", url: "/Runtime/Runtime/Form/ITHCA.OutgoingRequest.InProgressRequestForm/" },
                        { text: "Closed", url: "/Runtime/Runtime/Form/ITHCA.OutgoingRequest.ClosedRequestForm/" },
						{ text: "All Requests", url: "/Runtime/Runtime/Form/ITHCA.OutgoingRequest.AllRequestsForm/" },
						{ text: "My Tasks", url: "/Runtime/Runtime/Form/ITHCA.OutgoingRequest.WorklistForm/" },
                        { text: "Old Data", url: "/Runtime/Runtime/Form/OCMS.DataDashboard1/" }
					]
		}
    ];
